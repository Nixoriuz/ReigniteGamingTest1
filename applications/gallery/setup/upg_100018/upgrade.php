...
namespace IPS\gallery\setup\upg_100018;
...
class _Upgrade
{
    ...
    {
	    \IPS\Task::queue( 'core', 'RebuildReputationIndex', array( 'class' => 'IPS\gallery\Image' ), 4 );
	    \IPS\Task::queue( 'core', 'RebuildReputationIndex', array( 'class' => 'IPS\gallery\Image\Comment' ), 4 );
