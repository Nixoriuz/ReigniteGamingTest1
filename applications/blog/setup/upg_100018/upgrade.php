...
namespace IPS\blog\setup\upg_100018;
...
class _Upgrade
{
    ...
    {
	    \IPS\Task::queue( 'core', 'RebuildReputationIndex', array( 'class' => 'IPS\blog\Entry' ), 4 );
	    \IPS\Task::queue( 'core', 'RebuildReputationIndex', array( 'class' => 'IPS\blog\Entry\Comment' ), 4 );
