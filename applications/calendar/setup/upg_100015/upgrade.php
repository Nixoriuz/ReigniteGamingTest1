...
namespace IPS\calendar\setup\upg_100015;
...
class _Upgrade
{
	...
	{
		\IPS\Task::queue( 'core', 'RebuildItems', array( 'class' => 'IPS\calendar\Event' ), 3, array( 'class' ) );
		\IPS\Task::queue( 'core', 'RebuildItemCounts', array( 'class' => 'IPS\calendar\Event', 'count' => 0 ), 4, array( 'class' ) );
