...
class _Url
{
	...
	public static function runPlugin( $data, $options )
	{
		...
		{
			$url = "\IPS\Http\Url::internal( {$_data}{$csrf}, {$location}, \"{$options['seoTemplate']}\", {$options['seoTitles']}, {$options['protocol']} )".$fragment;
		}
		...
		{
			$url = "str_replace( '&', '&amp;', \IPS\Http\Url::internal( {$_data}{$csrf}, {$location}, \"{$options['seoTemplate']}\", {$options['seoTitles']}, {$options['protocol']} ){$fragment} )";
		}
