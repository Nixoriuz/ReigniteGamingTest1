...
public function upgrade()
	{
		...
		$form = new \IPS\Helpers\Form( NULL, NULL );
		$form->addMessage( "__iaf__nulling_null_alert", 'ipsMessage ipsMessage_error' ); //No requests to IPS. Only error message about Null.
