...
{	
	...
	{		
		...
		$table->rowButtons = function( $row )
		{
			...
			if ( \IPS\Member::loggedIn()->hasAcpRestriction( 'calendar', 'ical', 'calendar_feeds_edit' ) )
			{
				$return['edit'] = array(
					'icon'		=> 'pencil',
					'title'		=> 'edit',
			...
			if ( \IPS\Member::loggedIn()->hasAcpRestriction( 'calendar', 'ical', 'calendar_feeds_delete' ) )
			{
				$return['delete'] = array(
					'icon'		=> 'times-circle',
					'title'		=> 'delete',
		...
		/* Root buttons */
		if ( \IPS\Member::loggedIn()->hasAcpRestriction( 'calendar', 'ical', 'calendar_feeds_add' ) )
		{
